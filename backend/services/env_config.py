...
ENV_REGISTRY: List[Dict[str, Any]] = [
    ...
    {"key": "NEWS_SCHEDULER_ENABLED", "type": "bool", "requires_restart": True, "description": "Enable automatic news fetching scheduler"},
    {"key": "NEWS_VN_MARKET_INTERVAL_MINUTES", "type": "int", "requires_restart": True, "description": "VN news crawl interval during market hours (minutes)"},
    {"key": "NEWS_VN_OFF_HOURS_INTERVAL_MINUTES", "type": "int", "requires_restart": True, "description": "VN news crawl interval outside market hours (minutes)"},
    {"key": "NEWS_GLOBAL_INTERVAL_MINUTES", "type": "int", "requires_restart": True, "description": "Global news crawl interval (minutes)"},
